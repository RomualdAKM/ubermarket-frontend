    ...
    <main class="cuisine-contact-page">
      <div class="cuisine-container">
        ...
        <div class="cuisine-contact">
          ...
          <!-- Colonne formulaire (à venir) -->
          <div class="cuisine-contact__form-col">
            <div class="cuisine-contact__form-placeholder">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M8 10.5h8m-8 3h5.25M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
              </svg>
              <h3>Formulaire de contact</h3>
              <p>
                L'envoi de message directement depuis cette page sera bientôt disponible.
                En attendant, contactez-nous par téléphone{{ contactPhone ? ` au ${contactPhone}` : '' }}.
              </p>
            </div>
          </div>
        </div>
