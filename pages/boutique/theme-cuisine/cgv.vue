    ...
    <main class="cuisine-legal-page">
      <div class="cuisine-container">
        <div class="cuisine-section-header">
          ...
          <h1 class="cuisine-section-title">Conditions Générales de Vente</h1>
          <div class="cuisine-divider"><span class="cuisine-divider__ornament">✦</span></div>
        </div>

        <div v-if="salesTermsText" class="cuisine-legal__content">{{ salesTermsText }}</div>
        <div v-else class="cuisine-legal__empty">
          <p>Les conditions générales de vente de cette boutique n'ont pas encore été renseignées.</p>
        </div>
      </div>
    </main>
