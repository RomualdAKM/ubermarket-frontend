...
const termsText = computed(() => {
  return props.customizations?.terms?.text || 'Conditions générales d\'utilisation de la boutique. Veuillez lire attentivement ces conditions avant d\'utiliser nos services.'
})
