        ...
        <form @submit.prevent="submitForm">
          ...
          <div v-if="isPhysicalShop" class="border-b border-gray-200 pb-6 mb-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <!-- Options de précommande (affichées si précommande sélectionnée) -->
              <template v-if="productForm.availability_type === 'preorder'">
                ...
                <!-- Options d'acompte (affichées si acompte sélectionné) -->
...
// Watcher pour réinitialiser les valeurs d'acompte quand le type change
...
// Watcher pour réinitialiser les options de précommande quand le type de disponibilité change
